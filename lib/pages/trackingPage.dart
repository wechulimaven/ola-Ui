...
class _TrackingPageState extends State<TrackingPage> {
  ...
  String selectedProduct = 'OAL the best LPG';
                    ...
                    Container(
                      ...
                      child: DropdownButtonHideUnderline(
                        child: DropdownButton(
                          items: <String>[
                            'OAL the best LPG',
                            'OAL the best LP 200v',
                            'OAL the best LP 300v',
                            'OAL the best LP 400v',
                            'OAL the best LP 500v',
                            'OAL the best LP 500v'
                          ].map((val) {
                        ...
                        child: ConstrainedBox(
                          ...
                          child: Theme(
                            data:
                                ThemeData(primaryColor: orange, fontFamily: 'Montserrat'),
                            child: Stepper(
