...
List<String> timelines = ['Services Offered', 'Best of June', 'Best of 2018'];
String selectedTimeline = 'Services Offered';

List<Product> products = [
  Product(
      'assets/gas/gM.png',
      'Gas Cylinders',
      '''OAL Gas LPG Safety at Home Guide 
...
Use OAL gas recommended fittings. Ensure the hosepipe is replaced once it has reached its expiry date.''',
      102.99),
  Product(
  ...
  Widget build(BuildContext context) {
    ...
    Widget appBar = ClipPath(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Color(0xFF007DDD),
          image: DecorationImage(
            image: AssetImage("assets/ola/station.jpg"),
            fit: BoxFit.cover,
          ),
        ),
        child: Column(
          ...
          children: <Widget>[
            Flexible(
              child: InkWell(
                ...
                child: Text(timelines[0],
                    textAlign: TextAlign.center,
                    style: TextStyle(
                        fontSize: timelines[0] == selectedTimeline ? 21 : 14,
                        color: mediumGrey)),
              ),
            ),
            // Flexible(
